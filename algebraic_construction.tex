...
\begin{tabular}{|P{4.3cm}|m{5.2cm}|m{5.2cm}|}
    \hline
    {\bf Diagram} &\multicolumn{1}{c|}{\bf  Limit }& \multicolumn{1}{c|}{\bf Colimit } \\ 
    \hline\hline
    Empty Category $\varnothing$ & Terminal Object & Initial Object\\ 
    \hline
    ...
    $\begin{tikzcd}[every arrow/.append style={-latex, line width=1.2pt}]
        ...
        \end{center}\\
    \hline
        \begin{tikzcd}[every arrow/.append style={-latex, line width=1.2pt, shorten <=-4pt, shorten >=-4pt}]
    ...
    \begin{center}
        \begin{tikzcd}[every arrow/.append style={-latex, line width=1.2pt}]
            ...
            &                   & \varprojlim \arrow[ld, draw=arrowBlue, shorten <=-4pt] \arrow[rd, draw=arrowBlue, shorten <=-4pt]               &                   \\[-0.3cm]
...
\end{center}
    ...
    \begin{center}
        \begin{tikzcd}[every arrow/.append style={-latex, line width=1.2pt}]
            &   [-1.5em]                &[-1em] \circ \arrow[rdd, draw=cyan] \arrow[ldd, draw=cyan] & [-1em]                  \\
            &                   & \varinjlim \arrow[u, dash pattern=on 4pt off 2pt, draw=arrowRed] \arrow[ld, draw=arrowBlue, shorten <=-4pt] \arrow[rd, draw=arrowBlue, shorten <=-4pt]               &                   \\[-0.3cm]
    \bullet \arrow[r, shorten <=-3pt, shorten >=-3pt]& \bullet \arrow[rr] &                                                 & \cdots 
    \end{tikzcd}
\end{center}\\
    \hline
    \end{tabular}
