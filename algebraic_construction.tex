...
\end{center}
    ...
    \bullet \arrow[r, shorten <=-3pt, shorten >=-3pt]& \bullet  \arrow[ru, draw=arrowBlue, shorten >=-4pt]        \arrow[rr] \arrow[ruu, draw=cyan] &                                                 & \cdots \arrow[lu, draw=arrowBlue, shorten >=-3pt] \arrow[luu, draw=cyan]
    \end{tikzcd}
\end{center}\\
    \hline
    \end{tabular}
