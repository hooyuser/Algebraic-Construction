...
\include{macro_expanded/set_theory}
\include{macro_expanded/category_theory}
\include{macro_expanded/group}
\include{macro_expanded/topological_group}
\include{macro_expanded/ring}
\include{macro_expanded/commutative_ring}
\include{macro_expanded/module}
\include{macro_expanded/associative_algebra}
\include{macro_expanded/field}
\include{macro_expanded/valuation_theory}
\include{macro_expanded/number_theory}



% \begin{mmdefinition}{This is the theorem title}{labelForTheorem}
...
\begin{prf}
  \begin{tikzcd}
        ABC \arrow[loop right, "x"]{} \arrow[loop left, "y"]{} 
  \end{tikzcd}
\end{prf}

% \adddefinition{Sample Definition}{
%   This is an example of a definition using the custom command to reduce boilerplate code.
%  { \begin{tikzcd}
%     ABC \arrow[loop right, "x"]{} \arrow[loop left, "y"]{} 
%   \end{tikzcd}}
% }
