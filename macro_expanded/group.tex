...
\begin{example}{Actions on $X$ Induce Actions on $Y^X$}{acting_on_functions}
...
\begin{proposition}{Properties of Stabilizer Subgroup}{}
...
\begin{example}{$G$ Acts on Orbit $Gx$ Transitively}{}
...
\begin{example}{$G$ Acts on $G/H^L$ Transitively}{}
...
\begin{proposition}{$G$-Set Isomorphism $G/\mathrm{Stab}_G(x)^L\cong Gx$}{iso_stab_orbit}
...
\begin{proposition}{Properties of Conjugacy Class}{}
...
\begin{proposition}{Normalizer of a Subgroup}{}
