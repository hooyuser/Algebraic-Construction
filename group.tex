...
\ex{Forgetful Functor $U:\mathsf{Grp}\to \mathsf{Set}$}{
...
\prop{Free-Forgetful Adjunction $\mathrm{Free}_{\mathsf{Grp}}\dashv U$}{
...
\ex{Forgetful Functor $U: \mathsf{Ab}\to \mathsf{Grp}$}{
    The forgetful functor $U: \mathsf{Ab}\to \mathsf{Grp}$ is a functor that sends an abelian group to its underlying group. It is a fully faithful functor.
} 

\ex{Forgetful Functor $U: \mathsf{Ab}\to \mathsf{Set}$}{
